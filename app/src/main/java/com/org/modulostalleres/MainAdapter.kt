...
class MainAdapter(val homeFeed: HomeFeed): RecyclerView.Adapter<CustomViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.textViewModality).text = taller.modalidad
        holder.view.findViewById<TextView>(R.id.textViewArea).text = taller.area
        holder.view.findViewById<TextView>(R.id.textViewFechaInicio).text = taller.fecha_inicio
    }
